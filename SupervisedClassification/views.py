...
from SupervisedClassification.forms import PostForm
...
def handle_run_classification(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                img, boundary, scale, confusion_matrix = service.run_supervised_classification(filters, json.load(request.FILES['samples']))
